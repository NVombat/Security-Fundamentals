...
int main()
{
    ...
    */
    ...
    /*
    This binds the socket descriptor to the server thus enabling the server to
    listen for connections and communicate with other clients
    */
    ...
    */
    ...
    The SERVER then waits for the client to reply. It then receives the reply in
    the string variable and displays it (recv())
